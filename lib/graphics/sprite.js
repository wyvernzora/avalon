...
var Sprite = (function () {
  ...
  _createClass(Sprite, [{
    ...
    value: function move(params, animation) {
      ...
      this._pos.x = _util2['default'].first(params.x, this._pos.x);
      this._pos.y = _util2['default'].first(params.y, this._pos.y);
      this._transl.x = _util2['default'].first(params.translateX, this._transl.x);
      this._transl.y = _util2['default'].first(params.translateY, this._transl.y);
      this._scale.x = _util2['default'].first(params.scaleX, params.scale, this._scale.x);
      this._scale.y = _util2['default'].first(params.scaleY, params.scale, this._scale.y);
      this._rotate = _util2['default'].first(params.rotate, this._rotate);
